...
export class MessageService {
  ...
  getMessages(messagesParams: MessagesParams) {
    let params = new HttpParams();

    params = params.append('container', messagesParams.container);
    params = params.append('pageNumber', messagesParams.pageNumber);
    params = params.append('pageSize', messagesParams.pageSize);
